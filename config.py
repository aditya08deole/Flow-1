...
ROI_PADDING = {
    "top": -6,    # Shrink top by 7%
    "bottom": -6, # Shrink bottom by 7%
    "left": -12,  # Perfect balance between -10 and -18 to hide sticker but protect '4'
    "right": -22  # Aggressively shrink to completely cut off the right marker
}
